...
/**
* DivinumCoin Token Contract
* Copyright © 2017 by DivinumCoin https://goldgate.io
*/
...
contract Pausable is Ownable {
  ...
  /**
   * called by the owner to pause, triDVCers stopped state
   */
 ...
 * @title Ownable
 */
contract DVCOwnable is Ownable {
 ...
 */
contract DVCModerated is DVCOwnable {
 ...
 **/
contract ModToken is StandardToken, DVCPausable {
...
contract DivinumCoin is ModToken {
  string public constant version = "1.0.0";
  string public constant name = "DivinumCoin";
  string public constant symbol = "DVC";
  uint256 public constant decimals = 8;

  function DivinumCoin(uint256 _initialSupply) {   
